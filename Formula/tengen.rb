class Tengen < Formula
  ...
  url "https://github.com/nexusgen4561/tengen/archive/refs/tags/v1.0.2.tar.gz"
  sha256 "54b166631c1bfd5ed3a1396e2a4fab405c50ef479bb73195281ef046ed198a60"
  license "MIT"
  ...
  def caveats
    <<~EOS
      ...
      Launchpad, link the bundle into your Applications folder:
        ln -sfn "#{opt_prefix}/Tengen.app" ~/Applications/

      Tengen asks for Automation (Spotify/Music), Calendars, and Photos access
  ...
  test do
    bundle = prefix/"Tengen.app"
    assert_predicate bundle/"Contents/MacOS/Tengen", :executable?
    assert_match "Tengen", (bundle/"Contents/Info.plist").read
